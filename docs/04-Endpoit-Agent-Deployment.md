...
Following the successful deployment of the Wazuh server, the next phase of the project focused on integrating endpoint devices into the monitoring environment. Wazuh agents were deployed to both Windows and Ubuntu virtual machines, enabling the collection of security telemetry from multiple operating systems.

Each endpoint was configured to communicate securely with the Wazuh Manager using the standard agent registration and communication ports. Once deployed, the agents continuously forwarded security events to the central monitoring server, providing complete visibility across the simulated SME environment.
...
Successful connectivity confirmed that both endpoints could communicate with the monitoring server before agent deployment.

---

# Windows Agent Deployment

The Windows endpoint was registered using the Wazuh Dashboard deployment wizard.

During deployment, the following configuration was specified:

- Wazuh Manager Address
- Agent Name
- Windows Operating System

After installation, the Wazuh Agent service was started successfully and automatically established communication with the Wazuh Manager.

The successful deployment enabled Windows security telemetry to be forwarded to the SIEM platform for analysis.

---

# Ubuntu Agent Deployment

The Ubuntu Desktop endpoint was configured using the Linux deployment package provided by the Wazuh Dashboard.
...
Successful deployment was confirmed by:
...
The environment was now capable of centralised monitoring across both Windows and Linux endpoints.

---

# Screenshots

Include the following screenshots for this chapter.

```text
images/chapter04/01-windows-connectivity-test.png

images/chapter04/02-windows-agent-installed.png

images/chapter04/03-ubuntu-connectivity-test.png

images/chapter04/04-ubuntu-agent-running.png

images/chapter04/05-active-agents-dashboard.png
```

The final dashboard screenshot showing both active agents serves as the primary verification that endpoint integration was completed successfully.
